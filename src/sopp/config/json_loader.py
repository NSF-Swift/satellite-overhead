...
class ConfigFileLoaderJson(ConfigFileLoaderBase):
    ...
    def _frequency_range(self) -> FrequencyRange:
        ...
        return FrequencyRange(
            frequency=configuration["frequency"], bandwidth=configuration["bandwidth"]
        )
    ...
    def _antenna_position_times(self) -> list[PositionTime]:
        ...
        return configuration and [
            PositionTime(
                position=Position(
                    altitude=position_time["altitude"], azimuth=position_time["azimuth"]
                ),
    ...
    def _static_antenna_position(self) -> Position:
        ...
        return configuration and Position(
            altitude=configuration["altitude"], azimuth=configuration["azimuth"]
        )
